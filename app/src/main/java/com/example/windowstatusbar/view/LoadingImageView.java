...
public class LoadingImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private long mAnimDuration = 5000;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mMaskColor = t.getColor(R.styleable.LoadingImageView_mask_color, mMaskColor);
        mIsAutoStart = t.getBoolean(R.styleable.LoadingImageView_auto_start_anim, mIsAutoStart);
    ...
    private void initAnim() {
        stopAnim();
        mAnimator = ObjectAnimator.ofInt(mClipDrawable, "level", 0, 5000);
