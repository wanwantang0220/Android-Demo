package com.example.windowstatusbar.tapbarmenu;
...
public class TapBarMenu extends LinearLayout {
    ...
    private void setupAttributes(AttributeSet attrs) {
        ...
        if (typedArray.hasValue(R.styleable.TapBarMenu_tbm_iconOpened)) {
            ...
            iconOpenedDrawable = getDrawable(getContext(), R.drawable.icon_animated);
        }
        ...
        if (typedArray.hasValue(R.styleable.TapBarMenu_tbm_iconClosed)) {
            ...
            iconClosedDrawable = getDrawable(getContext(), R.drawable.icon_close_animated);
        }
